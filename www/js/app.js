...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
 ...
 /* .state('auth', {
  ...
  .state('app.home', {
    ...
    views: {
      'tab-home': {
        templateUrl: "views/app/home/tab-home.html",
        controller: 'HomeCtrl'
      }
    }
  })
  .state('app.offerdetail', {
    ...
    views: {
      'tab-home': {
        templateUrl: "views/app/home/offer-detail.html",
  ...
  .state('app.categories', {
    ...
    views: {
      'tab-categories': {
        templateUrl: "views/app/categories/tab-categories.html",
...
//Stores tab
  .state('app.stores', {
    ...
    views: {
      'tab-stores': {
        templateUrl: "views/app/stores/tab-stores.html",
  ...
  .state('app.storeDetail', {
    ...
    views: {
      'tab-stores': {
        templateUrl: "views/app/stores/store-detail.html",
  ...
  .state('app.faves', {
    ...
    views: {
      'tab-faves': {
        templateUrl: "views/app/faves/tab-faves.html",
        controller: 'AppCtrl'
      }
    }
  });
